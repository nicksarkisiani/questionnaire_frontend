...
interface CreateQuestionFormProps {
    templateId: number;
    isModalOpen: boolean;
    changeIsModalOpen: (boolean: boolean) => void
...
const CreateQuestionForm: FC<CreateQuestionFormProps> = ({ templateId, isModalOpen, changeIsModalOpen, onSubmitFunction}) => {
    const {Formik} = formik;
    ...
    return (
        <Modal show={isModalOpen} onHide={() => changeIsModalOpen(false)}>
            <Formik
